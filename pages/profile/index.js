...
const Profile = () => {
  ...
  const {
    ...
    mutateUser,
    loadingUser,
  } = useUser({ id: auth?.data?.id, token: auth?.data?.token });
  ...
  const saveEdit = (data) => {
    ...
    data.username
      ? formData.append("username", data.username || undefined)
      : "";
    ...
    data.password
      ? formData.append("password", data.password || undefined)
      : "";
          ...
          <Container fluid>
            <Row>
              ...
              <Col xs={12} lg={8} xl={9} className="px-5">
                ...
                {tabs === "saved" && (
                  <Saved post={savedPost} mutate={mutateSavedPost} />
                )}
              </Col>
            </Row>
          </Container>
