...
const Profile = () => {
  ...
  const { user: data, mutateUser } = useUser(auth?.data?.id, auth?.data?.token, { initialData: '' })
                ...
                <Row className='w-100 mx-3 justify-content-center align-items-center'>
                  <Col xs={12} lg={5}>
                    <div className='border p-2 d-flex justify-content-center profile-thumb'>
                      <img className='radius' width='80px' height='80px' src={data?.photo ? `${process.env.img_url}${data?.photo}` : '/images/profile-photo.png'} alt='profile-photo' />
                    </div>
                  </Col>
            ...
            <div className='w-100 d-flex justify-content-center position-relative mt-5'>
              <div className='d-flex justify-content-center align-items-center photo-profile'>
                <Form.Label className='pt-3'>
                  <img className='radius' width='100px' height='100px' src={data?.photo ? `${process.env.img_url}${data?.photo}` : '/images/profile-photo.png'} alt='profile-photo' />
                ...
                <Row className='justify-content-evenly g-5'>
                  ...
                  <Col xs={12} md={6}>
                    <Form.Group controlId="exampleForm.ControlInput1">
                      ...
                      <Form.Control defaultValue={data?.bio || 'Not Set'} as="textarea" rows={4} className='p-4 radius' disabled={disabled} {...register('about')} />
                    </Form.Group>
                  </Col>
                </Row>
              </Form>
