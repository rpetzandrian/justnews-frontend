    ...
    <>
      ...
      <div className="w-100 mt-5">
        <Card className="w-100 radius shadow-lg">
          ...
          <small className="mx-4 mb-5">{user?.about || "Not Set"}</small>
        </Card>
      ...
      <section className="mt-5 mb-3 profile-tabs">
        ...
        >
          ...
          <img
            className=""
            src={`/icons/angle-right${tabs === "edit" ? "-blue" : ""}.svg`}
            alt="right-angle"
          ></img>
        </div>
        <div
        ...
        >
          ...
          <img
            className=""
            src={`/icons/angle-right${tabs === "saved" ? "-blue" : ""}.svg`}
            alt="right-angle"
          ></img>
        </div>
        <div
        ...
        >
          ...
          <img
            className=""
            src={`/icons/angle-right${tabs === "faq" ? "-blue" : ""}.svg`}
            alt="right-angle"
          ></img>
        </div>
        <div
          className="d-flex justify-content-between align-items-center cursor"
          onClick={() => setTabs("help")}
        >
          <p className="pt-3">Help</p>
          <img
            className=""
            src={`/icons/angle-right${tabs === "help" ? "-blue" : ""}.svg`}
            alt="right-angle"
          ></img>
        </div>
        <div
          className="d-flex justify-content-between align-items-center cursor"
          onClick={() => {
            mutateAuth(actionAuth.authLogout());
          }}
        >
