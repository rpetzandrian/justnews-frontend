...
const NotificationCard = ({ show, data }) => {
  return (
    <>
      {show && (
        <Card className='position-fixed' style={{ width: '310px', right: '5px', top: '70px', maxHeight: '600px', borderRadius: '30px', zIndex: '123' }}>
          ...
          <div className='text-center pb-3'>
            <button className='border-0 bg-transparent text-primary'>See more</button>
          </div>
        </Card>
      )
      }
